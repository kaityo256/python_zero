...
本講義は慶応義塾大学理工学部物理情報工学科の「プログラミング基礎同演習」のテキストとして執筆されました。Google Colabを利用して講義するというアイディアは、同科の内山孝憲教授によるものです。本講義にあたり、TAの國府方大喜さん、原啓太さんにはTAを担当していただきました。特に國府方には多数のミスを指摘していただき、感謝しております。講義では学生さんから多数のフィードバックを頂きました。併せて感謝いたします。
