...
ここまで正しく入力できていれば、下向きの三角形が一つ表示されたはずだ。これはコッホ曲線の一段階目の変換をした画像である。
...
成功したら、`N`の数字を一つずつ増やしてみよ。また、変換ベクトルリスト`b`や、色のリスト`c`を適当に修正し、オリジナルのフラクタル図形を作成してみよ。
